...
LOCK TABLES `admin_up` WRITE;
/*!40000 ALTER TABLE `admin_up` DISABLE KEYS */;
INSERT INTO `admin_up` VALUES ('admin','1234');
/*!40000 ALTER TABLE `admin_up` ENABLE KEYS */;
UNLOCK TABLES;
